    ...
    <div className="container mx-auto ">
      <form className="flex items-center flex-col my-16  border shadow-2xl rounded-md lg:w-[800px]
       lg:ml-40 md:w-[350px] sm:w-[300px] sm:ml-20 " onSubmit={handleSubmit} >
        <Title addClass={"text-[56px] mb-12"}>Register</Title>
        <div className="flex flex-col gap-5 lg:w-[524px] md:w-[250]"  >
          ...
          <span>
          <Link href="/auth" className="hover:text-primary underline transition-all">I have an account</Link>

          </span>
          <Link href="/auth"><button className="btn-primary font-semibold hover:font-extrabold active:text-black ">REGISTER</button>  </Link>
        </div>
